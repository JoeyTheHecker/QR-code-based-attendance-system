...
<head>
  ...
  <title>DOLE - RO8 | Online Registration System</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="#">DOLE | RO8</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h2>WELCOME TO THE ONLINE <b>REGISTRATION SYSTEM </b>FOR THE 23RD PUBLIC EMPLOYMENT SERVICE OFFICE(PESO) CONGRESS.</h2>
          <h2>THIS DIGITAL GATEWAY IS DESIGNED TO STREAMLINE YOUR REGISTRATION PROCESS. ENSURING A SMOOTH AND CONVENIENT EXPERIENCE AS YOU PREPARE TO JOIN US FOR THIS EXCITING EVENT.</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="{{ url('register-peso') }}" class="btn-get-started scrollto">REGISTER NOW</a>
