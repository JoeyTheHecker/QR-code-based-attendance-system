...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{ route('scan') }}">Scan QRcode</a></li>
        </ul>
      </nav><!-- .navbar -->
  ...
  <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <a data-aos="fade-up" data-aos-delay="200" href="#get-started" class="btn-get-started">Register</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item" style="background-image: url(assets2/img/hero-carousel/hero-carousel-4.jpg)"></div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between gy-4">
          ...
          <div class="col-lg-5" data-aos="fade">
            <form method="POST" action="{{ route('store') }}"  class="registration-form">
                @csrf
              <h3>Register</h3>
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-12">
                  <input type="text" name="first_name" class="form-control" placeholder="firstname" required value="">
                </div>

                <div class="col-md-12">
                    <input type="text" name="middle_name" class="form-control" placeholder="middlename" required value="">
                  </div>

                <div class="col-md-12">
                    <input type="text" name="last_name" class="form-control" placeholder="lastname" required value="">
                </div>
